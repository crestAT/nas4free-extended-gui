...
$branch = "development";    // GIT branch: master, development
...
$return_val = mwexec("fetch {$verify_hostname} -vo {$dirname}/extended-gui/extended-gui-install.php https://raw.github.com/crestAT/nas4free-extended-gui/{$branch}/extended-gui/extended-gui-install.php", true);
if ($return_val == 0) { 
